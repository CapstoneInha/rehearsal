...
public class FindLastProjectHandler extends RequestHandlerImp<Project> {
    @Override
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        ...
        try {
            projectsBox = projectDao.findLastProjectByMemberId(Integer.parseInt(params.get("userId")));
